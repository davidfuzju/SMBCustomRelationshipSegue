...
@property (nonatomic, weak) IBOutlet UIView *privateButtonsView; /// The view hosting the buttons of the child view controllers.
@property (nonatomic, weak) IBOutlet UIView *privateContainerView; /// The view hosting the child view controllers views.
...
- (void)_addChildViewControllerButtons {
	...
	[self.viewControllers enumerateObjectsUsingBlock:^(ChildViewController *childViewController, NSUInteger idx, BOOL *stop) {
		
		UIButton *button = [UIButton buttonWithType:UIButtonTypeCustom];
        UIImage *icon = [UIImage imageNamed:childViewController.childImage];
		[button setImage:icon forState:UIControlStateNormal];
        UIImage *selectedIcon = [UIImage imageNamed:childViewController.childSelectedImage];
