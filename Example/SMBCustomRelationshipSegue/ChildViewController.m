...
- (void)setChildTitle:(NSString *)childTitle {
    _childTitle = childTitle;
    [self _updateAppearance];
}

- (void)setChildThemeColor:(UIColor *)childThemeColor {
    _childThemeColor = childThemeColor;
    [self _updateAppearance];
}

- (void)setChildImage:(NSString *)childImage {
    _childImage = childImage;
    [self _updateAppearance];
}

- (void)setChildSelectedImage:(NSString *)childSelectedImage {
    _childSelectedImage = childSelectedImage;
    [self _updateAppearance];
}
...
- (void)_updateAppearance {
	if ([self isViewLoaded]) {
		self.privateTitleLabel.text = self.title;
		self.view.backgroundColor = self.childThemeColor;
		self.view.tintColor = self.childThemeColor;
	}
}
